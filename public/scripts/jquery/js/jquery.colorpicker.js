  ...
  BFHColorPicker.prototype = {
    ...
    initPopover: function() {
      ...
      this.$element.html(
        ...
        '<div style="background-color:#808040;"></div>' +
        '<div style="background-color:#004040;"></div>' +
        '<div style="background-color:#0080FF;"></div>' +
        '<div style="background-color:#004080;"></div>' +
        '<div style="background-color:#8000FF;"></div>' +
        '<div style="background-color:#804000;"></div>' +
        '<div style="background-color:#808080;"></div>' +
        '<div style="background-color:#C0C0C0;"></div>' +
        '<div style="background-color:#F00000;"></div>' +
        '<div style="background-color:#F0F000;"></div>' +
        '<div style="background-color:#00F000;"></div>' +
        '<div style="background-color:#00F0F0;"></div>' +
        '<div style="background-color:#0000F0;"></div>' +
        '<div style="background-color:#F000F0;"></div>' +
        '<div style="background-color:#F0F080;"></div>' +
        '<div style="background-color:#00FF80;"></div>' +
        '<div style="background-color:#80FFFF;"></div>' +
        '<div style="background-color:#8080FF;"></div>' +
      ...
      this.$element
        ...
        .on('click.bfhcolorpicker.data-api', '.bfh-colorpicker-popover>div', BFHColorPicker.prototype.divClick)
    ...
    divClick: function (e) {
    	...
    	var aa = $parent.data('bfhcolorpicker');
    	var newColor = $(this).css('background-color');
    	var ar = newColor.substr(4, newColor.length-5).split(',');
    	newColor = rgbToHex(Math.round(ar[0]),Math.round(ar[1]),Math.round(ar[2]));
    	if (newColor !== aa.$element.val()) {
			aa.$element.val(newColor);
			aa.$element.trigger('change.bfhcolorpicker');
		}
